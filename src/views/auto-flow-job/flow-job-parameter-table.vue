  ...
  <div>
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="Key" prop="key" sortable="custom" align="center" min-width="150" :class-name="getSortClass('+key')" :sort-orders="['ascending', 'descending']">
          <template slot-scope="{row}">
            <span>{{ row.key }}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    getList() {
      ...
      const url = global_system_data_url + '/flow/job/parameter/ls?accesstoken=' + accesstoken
      fetch(url, {
        method: 'POST',
        headers: {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          const url = global_system_data_url + '/flow/job/parameter/add?accesstoken=' + accesstoken
          fetch(url, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json;charset=UTF-8'
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          const url = global_system_data_url + '/flow/job/parameter/update?accesstoken=' + accesstoken
          fetch(url, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json;charset=UTF-8'
    ...
    deleteData(row, index) {
      ...
      const url = global_system_data_url + '/flow/job/parameter/rm?accesstoken=' + accesstoken
      fetch(url, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json;charset=UTF-8'
