<template>
  <div>
    ...
    <div class="app-container">
      ...
      <el-dialog :title="logTextMap[dialogStatus]" :visible.sync="dialogFormLogVisible">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="margin-left:50px;">
          <el-form-item label="logcontent" prop="logcontent">
            <el-input v-model="temp.logcontent" />
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormLogVisible = false">
            Cancel
          </el-button>
          <el-button type="primary" @click="logListData">
            Confirm
          </el-button>
        </div>
      </el-dialog>
      <el-dialog :title="logTextMap[dialogStatus]" :visible.sync="dialogFormLogContentVisible">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="margin-left:50px;">
          <el-form-item label="logcontent" prop="logcontent">
            <el-input v-model="temp.logcontent" />
          </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormLogContentVisible = false">
            Cancel
          </el-button>
...
export default {
  ...
  data() {
    return {
      ...
      dialogFormLogVisible: false,
      dialogFormLogContentVisible: false,
      dialogStatus: '',
      textMap: {
        update: 'Edit',
        create: 'Create'
  ...
  methods: {
    ...
    handleLog(row) {
      ...
      this.dialogFormLogVisible = true
      this.$nextTick(() => {
        this.$refs['dataForm'].clearValidate()
      })
