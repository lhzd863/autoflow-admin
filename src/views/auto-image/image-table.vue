  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item v-if="dialogStatus==='create'?false:true" label="ImageId" prop="imageid">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dbstore: [{ required: true, message: 'dbstore is required. eg: /home/tmp/ins-dbstore.db', trigger: 'change' }],
        homedir: [{ required: true, message: 'homedir is required. eg: /home/tmp', trigger: 'change' }]
      }
    }
  },
  created() {
